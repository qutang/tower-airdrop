package edu.neu.mhealth.qutang.towerairdrop.sensors;
...
public class SensorListener implements SensorEventListener {
	...
	private void handleShakingInstructionScenario(float[] aValues) {
		...
		if(Flags.getFlags().instructionShakeMode&& GameSettingActivity.getInstruction(mContext)){
	...
	private void handleTiltingScenario(float[] aValue) {
		...
		if(Flags.getFlags().instructionTitleMode && GameSettingActivity.getInstruction(mContext)){
